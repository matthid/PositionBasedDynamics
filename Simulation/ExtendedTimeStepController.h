#ifndef __EXTENDEDTIMESTEPCONTROLLER_h__
#define __EXTENDEDTIMESTEPCONTROLLER_h__
...
namespace PBD
{
	class ExtendedTimeStepController : public TimeStep
	{
	public:
		// 		static int SOLVER_ITERATIONS;
		// 		static int SOLVER_ITERATIONS_V;
		static int NUM_SUBSTEPS;
	...
	protected:
		...
		unsigned int m_numSubsteps;
		unsigned int m_maxIterations;
		unsigned int m_maxIterationsV;

		virtual void initParameters();

		void positionConstraintProjection(SimulationModel& model, const Real dt);
		void velocityConstraintProjection(SimulationModel& model);


	public:
		ExtendedTimeStepController();
		virtual ~ExtendedTimeStepController(void);
